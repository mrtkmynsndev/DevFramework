...
namespace DevFramework.Core.Aspects.Postsharp.CacheAspects
{
    ...
    public class CacheAspect : MethodInterceptionAspect
    {
        ...
        public CacheAspect(Type cacheType, int cacheMinutes = 60)
        {
        ...
        public override void OnInvoke(MethodInterceptionArgs args)
        {
            ...
            var argumentsKey = string.Join(",", arguments.Select(x => x != null ? x.ToString() : "<Null>"));

            var key = $"{methodName}({argumentsKey})";
            ...
            _cacheManager.Add(key, args.ReturnValue, _cacheMinutes);
        }
    }
}
